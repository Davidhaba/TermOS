...
<details>
<summary><strong>Version 6.2.1 (6.2.0 → 6.2.1)</strong></summary>

### UI Improvements
- Enhanced desktop label readability
- Added a new Settings app with wallpaper selection
- Fixed window background transparency
